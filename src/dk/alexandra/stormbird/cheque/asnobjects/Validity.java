...
public class Validity extends Asn1Choice {
   ...
   public Validity (byte choiceId_, Asn1Type element_) {
      super();
   ...
   public void set_value (ValidityValue value) {
      ...
      throws Asn1Exception
   {
      ...
      // encode value
      case _VALUE:
         ValidityValue lvalue_ = (ValidityValue) getElement();
         buffer.getContext().eventDispatcher.startElement("value", -1);
