...
public class AlgorithmIdentifier extends Asn1SeqOf {
    ...
    * populated.
    */
   public AlgorithmIdentifier (int numRecords) {
    ...
    * given the array.  
    */
   public AlgorithmIdentifier (Asn1ObjectIdentifier[] elements_) {
      elements = elements_;
   }
      ...
      throws Asn1Exception, java.io.IOException
   {
      ...
      java.util.LinkedList<Asn1ObjectIdentifier> llist =
         new java.util.LinkedList<Asn1ObjectIdentifier>();
      ...
      elements = new Asn1ObjectIdentifier [llist.size()];
   ...
   {
      java.util.LinkedList<Asn1ObjectIdentifier> temp_seqof_list = new java.util.LinkedList<Asn1ObjectIdentifier>();
      /* decode as JSON array */
      buffer.readCharacter('[');
      if ( buffer.nextCharacterIsNot(']') ) {
         for(;;)  {
            Asn1ObjectIdentifier current_element_instance = new Asn1ObjectIdentifier();
      ...
      elements = new Asn1ObjectIdentifier[temp_seqof_list.size()];
